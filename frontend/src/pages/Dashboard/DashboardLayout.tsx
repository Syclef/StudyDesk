...
//
// Display name + logout live in the Dashboard page's own settings (gear)
// dropdown, not here — this layout wraps every page including ones far from
// the dashboard, so a persistent top-right identity/logout corner isn't
